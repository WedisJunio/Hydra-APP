...
export function getDisciplineLabel(discipline: string) {
  return discipline.charAt(0).toUpperCase() + discipline.slice(1).toLowerCase();
}

// ─── Helpers ─────────────────────────────────────────────────────────────────

export function getLiveSeconds(task: Task) {
...
export function filterTasksByPeriod(tasks: Task[], period: PeriodKey): Task[] {
...
export function DashboardDisciplina({
  discipline,
  projects,
  tasks,
  users,
